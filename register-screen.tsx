    ...
    <div className="min-h-screen flex flex-col bg-background safe-top safe-bottom">
      ...
      >
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center shadow-lg">
          <Baby className="w-8 h-8 text-primary-foreground" strokeWidth={1.5} />
        </div>
        <h1 className="mt-4 text-3xl font-bold text-foreground">Create Account</h1>
        <p className="mt-2 text-lg text-muted-foreground">Join BabyCare today</p>
      </motion.div>
      ...
      <motion.form
        ...
        className="flex-1 px-6 space-y-5 overflow-y-auto"
      >
        {/* Name */}
